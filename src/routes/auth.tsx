...
function AuthPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden overflow-y-auto flex items-center justify-center px-4 py-6 sm:py-10 md:py-16">
        ...
        return (
          <motion.span
            ...
            style={{
              ...
              height: size * 1.4,
              background:
                "radial-gradient(ellipse at center, #6b3a1f 0%, #3a1d0e 80%)",
              boxShadow:
      ...
      <motion.div
        ...
        className="relative w-full max-w-md sm:max-w-lg rounded-[28px] border border-white/15 p-5 sm:p-8 shadow-2xl mx-auto"
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(160deg, rgba(255,245,235,0.16) 0%, rgba(255,245,235,0.04) 100%)",
        ...
        >
          ...
          <div className="relative mx-auto w-fit mb-4">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <motion.span
                ...
                style={{
                  background:
                    "linear-gradient(135deg, #c98a5a 0%, #7a4a2a 100%)",
                }}
                animate={{
                  y: [0, -4, 0],
                }}
          ...
          <form
            onSubmit={doSignin}
            className="space-y-4 mt-5 sm:mt-7"
          >

            {/* Email */}
            <div className="space-y-1.5">
              <Label className="text-[rgba(255,245,235,0.85)]">
                Email
              </Label>
